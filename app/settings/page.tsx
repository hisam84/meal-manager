...
import { Settings, Download, CheckCircle2, Utensils, Save, AlertCircle } from 'lucide-react';
...
export default function SettingsPage() {
  ...
  return (
    <PageShell user={user} onLogout={handleLogout} title="সেটিংস ও ব্যাকআপ (Admin)">
          ...
          {/* Backup JSON */}
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-sm space-y-4 max-w-xl">
