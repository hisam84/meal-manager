    ...
    const htmlContent = `
      <div style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
          ...
          <tr><td style="padding: 8px; border: 1px solid #ddd;">Total Cook Bill (খালা বিল)</td><td style="padding: 8px; border: 1px solid #ddd; text-align: right; color: #0284c7;">${formatCurrency(summary.totalCookBill)}</td></tr>
